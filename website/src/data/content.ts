...
// 215 份分层可信资料（36 份核心馆方 + 179 份扩展可信与参观攻略）、78 个实体、87 条关系、90 题评测 v2

export const PROJECT_STATS = [
  { value: 215, unit: '份', label: '分层可信资料', note: '36 份核心馆方 + 179 份扩展可信与参观攻略，共 8.5 万余字' },
...
export const PIPELINE_STEPS = [
  { title: '可靠资料', desc: '215 份分层可信资料：36 份核心馆方 + 179 份扩展可信与参观攻略，白名单准入与逐份审核' },
