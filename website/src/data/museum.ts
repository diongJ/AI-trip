...
export const RELICS: Relic[] = [
  {
    ...
    theme: '王权', imageLabel: '金印', image: '/images/relics/wendi-seal.png', imageDetail: '/images/relics/wendi-seal-detail.png', importance: '墓中同时出现“文帝行玺”“帝印”与“赵眜”印章，成为确认墓主人身份的重要证据。',
  ...
  },
  {
    ...
    theme: '丧葬', imageLabel: '玉衣', image: '/images/relics/jade-suit.png', imageDetail: '/images/relics/jade-suit-detail.png', importance: '2291 片玉片以丝缕和麻布粘贴编缀，留下南越王对身份、礼制与生死的想象。',
  ...
  },
  {
    ...
    theme: '交流', imageLabel: '玉杯', image: '/images/relics/horn-cup.png', imageDetail: '/images/relics/horn-cup-detail.png', importance: '独特器形与温润玉质，提示南越与中原、海上世界之间多层次的文化交流。',
  ...
  },
  {
    ...
    theme: '礼制', imageLabel: '玉佩', image: '/images/relics/jade-pendant.png', imageDetail: '/images/relics/jade-pendant-detail.png', importance: '多件玉器通过佩系与组合形成等级表达，是理解南越礼制的一条细小线索。',
